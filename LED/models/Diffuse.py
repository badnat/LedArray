...
# update Logic
    def diff(self, i, j):
        if(i == 0 and j == 0):
            ...
            n = -2 * self.pix2[i, j][1] + self.pix2[i+1, j][1] + self.pix2[i, j+1][1] + self.pix2[i, j-1][1]
            return (n, 0, 255 - n)
        elif(i == 15):
            n = -2 * self.pix2[i, j][1] + self.pix2[i-1, j][1] + self.pix2[i, j+1][1] + self.pix2[i, j-1][1]
            return (n, 0, 255 - n)
        elif(j == 0):
            n = -2 * self.pix2[i, j][1] + self.pix2[i, j+1][1] + self.pix2[i+1, j][1] + self.pix2[i-1, j][1]
            return (n, 0, 255 - n)
        elif(j == 15):
            n = -2 * self.pix2[i, j][1] + self.pix2[i, j-1][1] + self.pix2[i+1, j][1] + self.pix2[i-1, j][1]
            return (n, 0, 255 - n)
        else:
            n = -3 * self.pix2[i, j][1] + self.pix2[i+1, j][1] + self.pix2[i-1, j][1] + self.pix2[i, j+1][1] + self.pix2[i, j-1][1]
            return (n, 0, 255 - n)
